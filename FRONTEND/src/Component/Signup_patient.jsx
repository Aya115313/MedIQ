...
function Signup_patient() {
  ...
  const validateForm = () => {
    ...
    if (!/^[A-Za-z\s]+$/.test(formData.localisation)) newErrors.localisation = "Only letters & spaces allowed!";
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        ...
        const response = await instance.post('/api/user/register/Patient', formDataToSend, {
          headers: {
    ...
    <div className="bigdiv1">
      {showNotification && (
        <div className="notification">
          ✅ Signup Successful! Welcome, patient!
        </div>
      )}
      ...
      <div className="signup-container">
        <div className="header">
          ...
          <h3>Hi, <span className="blue-text">patient!</span></h3>
